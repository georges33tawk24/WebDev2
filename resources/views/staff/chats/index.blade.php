...
@section('title', __('ui.staff.chats_title'))
@section('page-title', __('ui.staff.chats_title'))

@section('content')
<div class="page-header">
    <div>
        <div class="page-title">{{ __('ui.staff.chats_title') }}</div>
        <div class="page-subtitle">{{ __('ui.staff.chats_sub') }}</div>
    </div>
</div>
            ...
            <tbody>
                @forelse($requests as $request)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('staff.chats.show', $request) }}" class="btn-primary" style="padding:6px 12px; font-size:12px;">
